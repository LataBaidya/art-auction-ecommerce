...
const tabData = {
	Paintings: {
		...
		features: [
			...
			},
			{
				...
				description:
					"View detailed images of each painting before you buy or bid.",
				icon: EyeIcon,
			},
			{
	...
	Sculptures: {
		...
		description:
			"Our sculpture collection blends tradition with modern innovation.",
		features: [
			{
				name: "3D Detail",
	...
	Photography: {
		...
		description:
			"Dive into breathtaking photography captured by visionary artists.",
		features: [
			{
				name: "Framed Prints",
