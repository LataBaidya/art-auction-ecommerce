      ...
      <div className="pt-16 pb-80 sm:pt-24 sm:pb-40 lg:pt-40 lg:pb-48">
        <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
          <div className="sm:max-w-lg">
            <h1 className="text-5xl font-semibold tracking-tight text-gray-900 sm:text-6xl font-cormorantGaramond">
              Discover & Bid on Emerging Artists' Work
            </h1>
            <p className="mt-4 text-xl text-gray-500">
              Explore a curated selection of original paintings and photographs by new and rising
              artists. Place your bids and own unique pieces that tell powerful stories.
            </p>
          </div>
          <div>
            <div className="mt-10">
